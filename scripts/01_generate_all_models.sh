...
# Generate RelaCaTS-v1 teacher data for the three released base models.
#
...
LOG_BASE="${LOG_BASE:-${ROOT_DIR}/relacats_v1/outputs/logs/data_generation/all_models_gpu${GPU_FIRST}${GPU_SECOND}}"
HF_HOME="${HF_HOME:-/home/luorongchuan/workspace_135/datasets/.hf_cache_relacats_v1}"
HF_DATASETS_CACHE="${HF_DATASETS_CACHE:-${HF_HOME}/datasets}"
HF_ENDPOINT="${HF_ENDPOINT:-https://hf-mirror.com}"

GENERATOR="${GENERATOR:-${ROOT_DIR}/relacats_v1/scripts/01_generate_relational_data.sh}"
...
log "RelaCaTS-v1 all-model generation starting"
