...
OUTPUT_ROOT="${OUTPUT_ROOT:-${ROOT_DIR}/relacats_v1/outputs/generated_data}"
LOG_ROOT="${LOG_ROOT:-${ROOT_DIR}/relacats_v1/outputs/logs/data_generation}"
...
echo "RelaCaTS-v1 generation: physical GPUs ${GPU_FIRST},${GPU_SECOND};"
