...
OUTPUT_DIR="${OUTPUT_DIR:-${ROOT_DIR}/relacats_v1/outputs/checkpoints/qwen2_5_7b_instruct_relacats_v1}"
LOG_FILE="${LOG_FILE:-${ROOT_DIR}/relacats_v1/outputs/logs/train_qwen2_5_7b_gpu67.log}"
...
echo "Starting RelaCaTS-v1 on physical GPUs ${GPU_FIRST},${GPU_SECOND}; log=${LOG_FILE}"
