...
INPUT_ROOT="${INPUT_ROOT:-${ROOT_DIR}/relacats_v1/outputs/eval_outputs/confidence}"
OUTPUT_ROOT="${OUTPUT_ROOT:-${ROOT_DIR}/relacats_v1/outputs/eval_outputs/results}"
...
PY
  ...
  "${PYTHON_BIN}" -m relacats_v1.evaluation.aggregate "${aggregate_args[@]}"
done
echo "RelaCaTS-v1 evaluation reports (SC/CISC/Self-Certainty/Best-of-N/ASC/ESC/RASC + RelaCaTS-SC/RelaCaTS-ES/RelaCaTS-ASC): ${OUTPUT_ROOT}"
