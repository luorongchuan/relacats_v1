"""CPU micro-model smoke for the two RelaCaTS-v1 training losses."""
...
from relacats_v1.model_training.train_relacats import BatchEncoder, evaluate_loss, task_loss
