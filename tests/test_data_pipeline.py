...
from relacats_v1.common import atomic_write_json, atomic_write_jsonl, read_jsonl
from relacats_v1.core import compute_relssc
from relacats_v1.data_creation.build_relssc_dataset import build_dataset
from relacats_v1.data_creation.build_relssc_dataset import flatten_question
from relacats_v1.data_creation.build_relssc_dataset import validate_question_payload
from relacats_v1.data_creation.dataset_adapter import MCQExample
from relacats_v1.data_creation.generate_relational_data import (
...
class RelationalDataPipelineTests(unittest.TestCase):
    ...
    def test_numeric_extraction_prefers_final_marker(self):
        ...
        self.assertEqual(extract_numeric_answer("The result is 42"), "42")
