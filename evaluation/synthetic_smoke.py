"""Pure-CPU smoke test for every RelaCaTS-v1 evaluation aggregator.
...
from relacats_v1.common import atomic_write_jsonl
from relacats_v1.evaluation.aggregate import AggregateConfig, run_aggregation
